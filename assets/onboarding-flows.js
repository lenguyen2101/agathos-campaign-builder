...
var FLOWS = {
  ...
  'ret1': {
    ...
    nodes:[
      ...
      {id:'c', t:'step', r:2, c:1, l:'Context bar', s:'Continue with [Org]'},
  ...
  'ret2': {
    ...
    nodes:[
      ...
      {id:'c0', t:'ext', r:2, c:0, l:'Add organisation', s:'→ Diagram 2, account step skipped'},
  ...
  'expiring': {
    ...
    nodes:[
      ...
      {id:'b', t:'step', r:1, c:1, l:'Context bar', s:'Continue with [Org]'},
  ...
  'indiv': {
    ...
    nodes:[
      ...
      {id:'c1', t:'ext', r:2, c:2, l:'Full Step 4B', s:'ID · proof of address · cause statement → manual review'},
